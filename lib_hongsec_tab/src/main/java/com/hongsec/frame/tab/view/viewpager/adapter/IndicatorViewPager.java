 ...
 */
package com.hongsec.frame.tab.view.viewpager.adapter;
...
import com.hongsec.frame.tab.view.indicator.FragmentListPageAdapter;
import com.hongsec.frame.tab.view.indicator.Indicator;
import com.hongsec.frame.tab.view.indicator.slidebar.ScrollBar;
import com.hongsec.frame.tab.view.viewpager.RecyclingPagerAdapter;
...
public class IndicatorViewPager {
	...
	/**
	 * viewpage 的每个页面是view的形式 <br>
	 *  例如:简单加入 图片的那种。 例如新闻类 公告导航等
